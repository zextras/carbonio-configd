...
func TestDoPostconf_BooleanNormalization(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "VAR TRUE -> yes", valueSpec: "VAR:zimbraBool", resolved: "TRUE", want: "yes"},
		{name: "VAR FALSE -> no", valueSpec: "VAR:zimbraBool", resolved: "FALSE", want: "no"},
		{name: "VAR lowercase true -> yes", valueSpec: "VAR:zimbraBool", resolved: "true", want: "yes"},
		{name: "VAR non-bool passthrough", valueSpec: "VAR:zimbraBool", resolved: "mail.example.com", want: "mail.example.com"},
		{name: "LOCAL FALSE -> no", valueSpec: "LOCAL:someKey", resolved: "FALSE", want: "no"},
