...
var tokenNames = [TokenComment + 1]string{
	...
	TokenRewrite:    ConfigTypeREWRITE,
	TokenVar:        ConfigTypeVAR,
	TokenLocal:      ConfigTypeLOCAL,
	TokenService:    ConfigTypeSERVICE,
	TokenPostconf:   ConfigTypePOSTCONF,
	TokenPostconfd:  ConfigTypePOSTCONFD,
	TokenRestart:    ConfigTypeRESTART,
	TokenDepends:    ConfigTypeDEPENDS,
	TokenMapfile:    ConfigTypeMAPFILE,
	TokenMaplocal:   ConfigTypeMAPLOCAL,
	TokenMode:       ConfigTypeMODE,
